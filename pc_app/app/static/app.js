...
function renderDerivedModelSummary(links, preset = {}) {
  ...
  elements.linkCalibration.innerHTML = `
    <div class="log-line"><span>Base view</span><code>L1 ${format(length("L_1"), 2)} mm, L2 ${format(length("L_2"), 2)} mm, L3 ${format(length("L_3"), 2)} mm</code></div>
    <div class="log-line"><span>d1</span><code>${format(links.base_height, 2)} mm = L1 + L3; L2 is visual support, not active DH</code></div>
